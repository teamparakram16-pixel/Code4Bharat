...
export function AllRoutinePosts() {
  ...
  const { getAllRoutinesPost, filterSearch,deleteRoutine  } = useRoutines();
  ...
  const fetchAllPosts = async () => {
    try {
      ...
      setRoutinePosts([]); // Ensure it's always an array
      setIsLoading(false);
      ...
      <Container maxWidth={false}>
        ...
        <PostsContainer>
          {isLoading ? (
            ...
            >
              <NoPostFound
                message="No routines found. Try adjusting your search or filters to find what you're looking for."
                onReset={() => {
                  setSearchQuery("");
                  fetchAllPosts();
                }}
