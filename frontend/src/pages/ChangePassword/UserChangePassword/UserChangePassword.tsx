...
const UserChangePassword: React.FC = () => {
  ...
  const {
    ...
    setError,
    setSuccess
  } = useChangePassword({ endpoint: `${import.meta.env.VITE_SERVER_URL}/api/users/change-password` });
          ...
          <LeftPanel>
            <Box sx={{ position: 'relative', zIndex: 1, height: '100%', display: 'flex', flexDirection: 'column' }}>
              ...
              <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                ...
                >
                  Update your password to ensure your account remains protected
                </Typography>
                ...
                <Box sx={{ mt: { xs: 2, md: 4 }, display: { xs: 'none', md: 'block' } }}>
                  <FeatureItem>
                    ...
                    <Box>
                      ...
                      >
                        Your security is our priority with end-to-end protection
                      </Typography>
                    </Box>
                  </FeatureItem>
